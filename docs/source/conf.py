...
# -*- coding: utf-8 -*-
#
# vuewidget documentation build configuration file
#
...
_version_py = os.path.join(repo, 'vuewidget', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'vuewidgetdoc'
...
latex_documents = [
    (master_doc, 'vuewidget.tex', 'vuewidget Documentation',
     'Jean Boehm', 'manual'),
]
